...
export const PreparationSection: React.FC<PreparationSectionProps> = ({rows}) => {
    return (
        <div className="w-full flex flex-col px-[28px] py-[22px] rounded-[10px] bg-rose-50">
            <div className="flex flex-col gap-[13px]">
                <div className="font-outfit font-bold text-[20px] text-rose-800">Preparation time</div>
